  ...
  <div style="height:50px">
    <div class="fd-shellbar fd-shellbar--xl">
      <div class="fd-shellbar__group fd-shellbar__group--product">
        <span class="fd-shellbar__logo"><img
      ...
      <div class="fd-shellbar__group fd-shellbar__group--center fd-shellbar__group--mobile-flex">
        <div class="fd-shellbar__action fd-shellbar__action--grow">
          <div id="JKHhjk7234k" class="fd-input-group fd-shellbar__search-field">
            ...
            <input id="F4GcX348b1" aria-label="search-input" type="text" onfocus="addClass('JKHhjk7234k', 'is-focus')" onblur="removeClass('JKHhjk7234k', 'is-focus')" class="fd-input fd-input-group__input fd-shellbar__search-field-input" placeholder="Search everything">
            <div class="fd-input-group__addon fd-input-group__addon--button fd-shellbar__search-field-addon fd-shellbar__search-cancel">
              <button aria-label="button-search" class="fd-button fd-button--transparent fd-shellbar__button">
                <i class="sap-icon--decline" />
              </button>
            </div>
            <div class="fd-input-group__addon fd-shellbar__search-field-addon fd-input-group__addon--button fd-shellbar__search-submit">
      ...
      <div class="fd-shellbar__group fd-shellbar__group--actions">
          ...
          <div class="fd-shellbar-collapse">
            <div class="fd-popover fd-popover--right">
              <div class="fd-popover__control">
                <div
                  class="fd-shellbar-collapse--control" onclick="onPopoverClick('CWaGGD78')"
                  aria-controls="CWaGGD78" aria-expanded="false" aria-haspopup="true" role="button"
                >
                  <button
                    class="fd-button fd-button--transparentfd-shellbar__button" aria-controls="undefined"
                    aria-haspopup="true" aria-expanded="false"
                  >
                    <i class="sap-icon--overflow" />
              ...
              <div
                id="CWaGGD78"
                class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--right" aria-hidden="true"
              >
                <nav class="fd-menu">
        ...
        <div class="fd-shellbar__action">
          <div class="fd-popover fd-popover--right">
            ...
            <div
              id="DD35G276" class="fd-popover__body fd-popover__body--no-arrow fd-popover__body--right"
              aria-hidden="true"
            >
              <nav class="fd-menu">
                <ul class="fd-menu__list fd-menu__list--no-shadow">
