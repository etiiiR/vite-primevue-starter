      ...
      <template #footer>
        <div class="flex items-center justify-between bg-white">
          ...
          <div class="flex">
            ...
            <Button label="Cancel" plain text />
          </div>
        </div>
      </template>
      <DataTable v-if="Tab === 'columns'" v-model:selection="selectedProduct" scrollable scroll-height="flex" :value="prods.columns" data-key="field" table-style="min-width: 20rem" @rowReorder="onRowReorder">
